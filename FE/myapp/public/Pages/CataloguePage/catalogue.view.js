  ...
  makeMainContent = (item) => {
    ...
    let textNode = `
      <div class="row contract">
        <button class="btn btn-lg col-lg-4 col-xs-4 pull-left buy_btn"> 청약 / 매수 </button> : 사는 가격 : $${item.buyOffer}
        <button class="btn btn-lg col-lg-4 col-xs-4 pull-right sell_btn"> 청약취소 / 매도 </button> : 파는 가격 : $${item.sellOffer}
      </div>
