        ...
        <div class="row">
          <div class="menu col-lg-2 col-xs-2">
            <div class="row">
                <div class="col">
                  ...
                  <a class="selected" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><p>item</p></a>
                  <ul id="collapseOne" class="nav flex-column collapse in">
                    <li>
                      <a href="#" class="selected">Total</a>
                    </li>
                    <li>
                      <a href="#">IPO Stage</a>
                    </li>
          ...
          <div class="item_detail col-lg-7 col-xs-7">
            <div class="row contract">
              <button class="btn btn-lg col-lg-4 col-xs-4 pull-left"> 청약 / 매수 </button>
              <button class="btn btn-lg col-lg-4 col-xs-4 pull-right"> 청약취소 / 매도 </button>
            </div>
